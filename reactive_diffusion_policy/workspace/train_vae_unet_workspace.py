...
from reactive_diffusion_policy.model.vae_unet.vae_unet import ActionVAE as VAE
...
class TrainVaeUnetWorkspace(BaseWorkspace):
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}",
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        # compute loss
                        loss, encoder_loss, kl_loss = self.model.calculate_loss(batch)
                        raw_loss = loss
                    ...
                    with torch.no_grad():
                        ...
                        with tqdm.tqdm(val_dataloader, desc=f"Validation epoch {self.epoch}",
                            ...
                            for batch_idx, batch in enumerate(tepoch):
                                ...
                                # metric
                                val_encoder_loss.append(encoder_loss)
