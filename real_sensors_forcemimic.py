...
class RealRobotEnv:
    ...
    def synced_callback(self, camera_1_image, camera_2_image, camera_1_depth, camera_2_depth, tac1_data, tac2_data, xarm_eef):
        ...
        deform_emb_1 = (deform1[:,:-1].reshape(-1, 1)[0] - self.left_tac_mean_matrix) @ self.left_tac_transform_matrix
        ...
        raw_obs_dict['left_gripper1_marker_offset_emb'] = deform_emb_1
        raw_obs_dict['left_gripper2_marker_offset_emb'] = deform_emb_2
