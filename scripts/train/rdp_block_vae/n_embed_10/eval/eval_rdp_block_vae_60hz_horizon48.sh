...
LOGGING_MODE="online"
TIMESTAMP=eval_vase_sponge1_rdp_vae_60hz_horizon48
SEARCH_PATH="./data/outputs"

vae_load_path="data/outputs/2026.01.08/02.31.11_train_vae_real_wipe_vase_sponge1_rdp_block_vae_60hz_horizon48/checkpoints/latest.ckpt"

# Stage 1: Train Asymmetric Tokenizer
echo "Stage 1: training Asymmetric Tokenizer..."
CUDA_VISIBLE_DEVICES=${GPU_ID} python train.py \
    --config-name=eval_rdp_block_vae_workspace \
