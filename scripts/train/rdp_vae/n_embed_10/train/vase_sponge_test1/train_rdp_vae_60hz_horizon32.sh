...
LOGGING_MODE="online"
TIMESTAMP=vase_sponge1_rdp_vae_60hz_horizon32
...
# # AT_LOAD_DIR=data/outputs/2025.11.13/22.03.32_train_vae_real_wipe_image_gelsight_emb_at_24fps_vase_a/checkpoints/latest.ckpt
