...
"""
# 1hz: 1.31s end2end
python scripts/xarm_control/interpolate_control_position.py --pointnum 1
# 15hz: 5.31s end2end, single step 0.35s~0.36s
python scripts/xarm_control/interpolate_control_position.py --pointnum 15
"""
...
def main(ip):
    ...
    parser.add_argument("--pointnum", type=int, default=12, help="运动目标的个数, 为1代表只有终点和起点")
    ...
    end_pose = [243.410767, 491.847595, 332.45575, -178.274959, 2.825656, -179.190316] # 599.053223
